...
updated: $FOAM_DATE_YEAR-$FOAM_DATE_MONTH-$FOAM_DATE_DATE
...
- a placeholder optionally has a default value, which can be some text or, as in this case, a [variab\le](https://code.visualstudio.com/docs/editor/userdefinedsnippets#_variables)
